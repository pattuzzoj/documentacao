...
<p>- <span style="font-weight: 800">Linguagem de Alto Nível:</span> uma linguagem de programação que se aproxima da linguagem humana, como o Portugol, uma linguagem de programação focada no ensino.<br>
