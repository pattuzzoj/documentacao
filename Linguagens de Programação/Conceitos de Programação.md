...
<p>- <h4 style="display: inline">Linguagem de Alto Nível:</h4> uma linguagem de programação que se aproxima da linguagem humana, como o Portugol, uma linguagem de programação focada no ensino.<br>
